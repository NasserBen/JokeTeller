...
function toggleButton() {
    ...
    replayBtn.disabled = !replayBtn.disabled;
}
// Passing joke into Voice api
function tellJoke(joke) {
    VoiceRSS.speech({
        key: 'c196d980549c455bb1e78c4f250660f7',
        src: joke,
        hl: 'en-us',
        v: 'Linda',
        r: 0, 
...
replayBtn.addEventListener('click', ()=> {replayJoke(); toggleButton();});
